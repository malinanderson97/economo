...
// value of d1, d2, c1, or m1 — the baseline equilibrium calibrated to Y=100
...
// below, so the d1/d2/c1/m1 mutations are caught. Gap closed; this script now
...
//   • `d2 = 200`   → the interest-rate response; corrupting it breaks ΔY/Δr.
...
const MODELS = [
  {
    ...
    // NOTE: v19's verifier used to be insensitive to d1/d2/c1/m1 parameters
    ...
    mutations: [
      ...
      { label: 'break interest response (d2 200 → 20)', from: 'd2 = 200', to: 'd2 = 20' },
