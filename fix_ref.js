...
const correctCode = `  'i*': { meaning: 'foreign nominal interest rate', ref: 'eq. 19.5', role: 'return on foreign bonds' },
...
code = code.replace(/  'i\*': \{ meaning: 'foreign nominal interest rate', ref: 'eq\. 19\.5', role: 'return on foreign bonds' \},[\s\S]*?pi_e': 'Model Textbook Correspondence 6\.6'\n\};/, () => correctCode);

fs.writeFileSync(file, code);
console.log("Restored SYMBOL_DEFS and EQ_REF safely.");
